...
if __name__ == '__main__':
    ...
    names = ["Selection Sort","Bubble Sort","Bubble Sort With Escape", "Insertion Sort", "Merge Sort","Quick Sort"]  # TODO: add the names of each sorting method in the order they are saved in the text file
